...
export default function MyPosts(){
    ...
    useEffect(() => {
        ...
        if (!loggedInUser) {
            ...
            fetchUserPosts(userData.user_id)
        }
    }, [navigate])
        ...
        <div className="w-screen h-screen flex flex-row bg-primary">
            <div className="w-1/5 bg-secondary flex flex-col p-10 justify-between border-r border-gray-300 h-screen">
                ...
                <div className="flex gap-2 hover:invert transition duration-300 cursor-pointer">
                    ...
                    <Link to="/main" className="text-3xl font-bold text-black">Feed</Link>
                </div>
                <div/>
                <div>
            ...
            <div className="flex flex-row w-4/5 h-screen">
                ...
                <div className="bg-secondary flex flex-col w-2/3 h-screen">
                    <h1 className="font-semibold text-4xl px-11 pt-6 pb-4 text-black bg-secondary border-b border-gray-300 text-center">My Posts</h1>
                    <div className="flex-1 overflow-y-auto p-11">
                        <div className="w-full max-w-2xl mx-auto">
                            ...
                            {loading ? (
                                ...
                                <p className="text-text text-xl text-center">You haven't posted anything yet. Share your first post!</p>
                            ) : (
                                posts.map(post => (
                                    <Post 
                                        key={post.post_id} 
